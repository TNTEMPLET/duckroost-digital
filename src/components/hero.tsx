  ...
  return (
    <section className="relative overflow-hidden px-4 pb-20 pt-16 sm:px-6 sm:pb-28 sm:pt-24">
      <div
        ...
        aria-hidden
      >
        <div className="absolute -left-1/4 top-0 h-[420px] w-[420px] rounded-full bg-[var(--color-accent)]/20 blur-[120px]" />
        <div className="absolute -right-1/4 bottom-0 h-[380px] w-[380px] rounded-full bg-sky-500/10 blur-[100px]" />
      </div>
      <div className="relative mx-auto max-w-6xl">
        ...
        <div className="mt-10 flex flex-wrap gap-4">
          <Link
            href="#work"
            className="inline-flex items-center justify-center rounded-full bg-white px-6 py-3 text-sm font-medium text-[var(--color-surface)] transition-opacity hover:opacity-90"
          >
            View web apps
          </Link>
          <Link
